...
class Atiktypes(models.Model):
     ...
     whatIsIt = models.TextField(max_length=1000)
     whyİmportant =  models.TextField(max_length=1000)
     whereAccours =  models.TextField(max_length=1000)
     howUnderstand =  models.TextField(max_length=1000)
